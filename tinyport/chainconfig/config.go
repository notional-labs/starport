...
var (
	// ConfigDirPath returns the path of configuration directory of Tinyport.
	ConfigDirPath = xfilepath.JoinFromHome(xfilepath.Path(".tinyport"))

	// ConfigFileNames is a list of recognized names as for Tinyport's config file.
...
var (
	...
	ErrCouldntLocateConfig = errors.New(
		"could not locate a config.yml in your chain. please follow the link for" +
			"how-to: https://github.com/notional-labs/tinyport/blob/develop/docs/configure/index.md")
)
