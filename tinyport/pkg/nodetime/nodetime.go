...
// the CLI bundled programs are the ones that needed by Tinyport and more can added as needed.
package nodetime
...
import (
	...
	"github.com/notional-labs/tinyport/tinyport/pkg/nodetime/data"
)
...
const (
	...
	// CommandXRelayer is a relayer wrapper for Tinyport made using the confio relayer.
