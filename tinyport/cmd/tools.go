...
import (
	...
	"github.com/notional-labs/tinyport/tinyport/pkg/nodetime"
...
func NewToolsIBCSetup() *cobra.Command {
	return &cobra.Command{
		...
		Example: `tinyport tools ibc-setup -- -h
...
func NewToolsIBCRelayer() *cobra.Command {
	return &cobra.Command{
		...
		Example: `tinyport tools ibc-relayer -- -h`,
	}
}
...
func NewToolsProtoc() *cobra.Command {
	return &cobra.Command{
		...
		Example: `tinyport tools protoc -- --version`,
	}
}
