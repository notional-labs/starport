...
// https://github.com/notional-labs/tinyport/issues/818#issuecomment-865736052
const govWarning = `⚠️ If your app has been scaffolded with Tinyport 0.16.x or below
