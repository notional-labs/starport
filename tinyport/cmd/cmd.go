...
import (
	...
	"github.com/notional-labs/tinyport/tinyport/pkg/clispinner"
	"github.com/notional-labs/tinyport/tinyport/pkg/cosmosaccount"
	"github.com/notional-labs/tinyport/tinyport/pkg/cosmosver"
	"github.com/notional-labs/tinyport/tinyport/pkg/events"
	"github.com/notional-labs/tinyport/tinyport/pkg/gitpod"
	"github.com/notional-labs/tinyport/tinyport/pkg/goenv"
	"github.com/notional-labs/tinyport/tinyport/pkg/xgenny"
	"github.com/notional-labs/tinyport/tinyport/services/chain"
	"github.com/notional-labs/tinyport/tinyport/services/scaffolder"
)
...
func New(ctx context.Context) *cobra.Command {
	...
	c := &cobra.Command{
		Use:   "tinyport",
		Short: "Tinyport offers everything you need to scaffold, test, build, and launch your blockchain",
		Long: `Tinyport is a tool for creating sovereign blockchains built with Cosmos SDK, the world’s
...
func deprecated() []*cobra.Command {
	return []*cobra.Command{
		{
			Use:        "app",
			Deprecated: "use `tinyport scaffold chain` instead.",
		},
		{
			Use:        "build",
			Deprecated: "use `tinyport chain build` instead.",
		},
		{
			Use:        "serve",
			Deprecated: "use `tinyport chain serve` instead.",
		},
		{
			Use:        "faucet",
			Deprecated: "use `tinyport chain faucet` instead.",
		},
	}
}
...
func checkNewVersion(ctx context.Context) {
	...
	fmt.Printf(`·
· 🛸 Tinyport %s is available!
·
· To upgrade your Tinyport version, see the upgrade doc: https://docs.tinyport.network/guide/install.html#upgrading-your-tinyport-installation
·
··
...
https://docs.tinyport.network/migration`, sc.Version.String(),
		)
	}
	return sc, nil
}
