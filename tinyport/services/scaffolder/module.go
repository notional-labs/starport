...
import (
	...
	appanalysis "github.com/notional-labs/tinyport/tinyport/pkg/cosmosanalysis/app"
	...
	"github.com/notional-labs/tinyport/tinyport/templates/module"
	modulecreate "github.com/notional-labs/tinyport/tinyport/templates/module/create"
	moduleimport "github.com/notional-labs/tinyport/tinyport/templates/module/import"
)
...
func (s Scaffolder) ImportModule(tracer *placeholder.Tracer, name string) (sm xgenny.SourceModification, err error) {
	...
	if err != nil {
		...
		if errors.As(err, &validationErr) {
			...
			return sm, errors.New("wasm cannot be imported. Apps initialized with Tinyport <=0.16.2 must downgrade Tinyport to 0.16.2 to import wasm")
		}
		return sm, err
	}
