...
import (
	...
	"github.com/notional-labs/tinyport/tinyport/pkg/dirchange"
	"github.com/notional-labs/tinyport/tinyport/pkg/localfs"
	"github.com/notional-labs/tinyport/tinyport/pkg/xexec"
	"github.com/notional-labs/tinyport/tinyport/pkg/xfilepath"
	"github.com/notional-labs/tinyport/tinyport/pkg/xhttp"
			...
			case <-c.serveRefresher:
				...
				case errors.As(err, &buildErr):
					...
					if errors.As(err, &validationErr) {
						fmt.Fprintln(c.stdLog().out, "see: https://github.com/notional-labs/tinyport#configure")
					}
...
If the new code is no longer compatible with the saved state, you can reset the database by launching:`), "tinyport chain serve --reset-once")
