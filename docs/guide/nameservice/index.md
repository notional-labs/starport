...
This tutorial builds on knowlege and skills developed in the earlier tutorials in the Tinyport Developer Tutorials. Before you start this building your nameservice app, we recommend that you complete these foundational tutorials:

- [Install Tinyport](../install.md)
...
- A supported version of [Tinyport](https://docs.tinyport.com/). To install Tinyport, see [Install Tinyport](../tinyport/install.md). 
...
- [Tinyport](https://docs.tinyport.com/) is built on top of Cosmos SDK and accelerates chain development by scaffolding everything you need. 
